  ...
  return (
    <>
      <Form className=" w-full pb-11 sm:pb-200">
        ...
        <div className=" w-full dir-ltr mt-6 sm:mt-8 lg:mt-10 space-y-5">
          <div>
            <div className=" w-full relative">
              <Input
                name="fullname"
                className="w-full caret-gray-300 outline-none border-2 border-solid border-transparent transition-all  focus:border-gray-500 placeholder:text-gray-400 placeholder:select-none text-base lg:text-xl rounded-xl py-3 lg:py-5 placeholder:text-right pr-14 lg:pr-18 pl-4 lg:pl-6 text-gray-200  bg-gray-700"
