...
export default function HeaderSingleEpisode({ episode }: props) {
  ...
  return (
    <>
      <div className=" bg-dark-600   grid  grid-cols-12 lg:grid-cols-12 rounded-2xl select-none p-4 lg:p-7 gap-3 ">
        <div className=" col-span-3 bg-dark-700 p-4  overflow-y-auto hideSB max-h-[42.5rem]" >
         {
