...
import CardBlogSearchLayout from "./CardBlogForSearchLayout";
import { Blog } from "@/libs/model/blog";
import { GetAllBlogs } from "@/libs/services/home/blog";

export default function SearchBarBlogayout() {
  ...
  const searchCoursebySearch = async () => {
    setLoading(true)
    let blogData = await GetAllBlogs({ search: searchText });
    setLoading(false);
