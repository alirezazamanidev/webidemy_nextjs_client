            ...
            <div className=" w-full">
              <ul className=" w-full flex justify-around items-end select-none">
                <li
                  ...
                  className={`cursor-pointer w-full p-3 sm:p-4 text-base lg:text-2xl text-center relative transition-all after:h-0.5 after:w-full after:absolute after:bottom-0 after:left-1/2 after:-translate-x-1/2 after:transition-all after:hover:bg-blue-250 ${
                    pagePath === "login"
